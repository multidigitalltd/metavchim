...
export class SuggestController {
   ...
   * ההתראות שלו — וזה מחזיר נתוני משרד. ההצהרה כאן היא מי שצריך
   * את האוצר בפועל.
   *
   * ‎**ו-`buyers.view_own` הוא חלק מהרשימה מאז שסינון השכונות
   * נולד.** עד כה נדרשה יכולת כתיבה, כי ההשלמה שירתה טפסים
   * בלבד. עכשיו הבורר בעמוד הקונים שואב מאותו אוצר, ומי
   * שרואה קונים בלי לערוך אותם היה מקבל 403 שהשדה בולע בשקט:
   * בורר שנראה עובד ומציע תמיד „אין שכונות”. המסך והשער
   * חייבים להסכים על מי רשאי.
   *
