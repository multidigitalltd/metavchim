...
export class TelephonyService {
   ...
   *
   * הקריאה הראשונה צופה ושומרת; כל קריאה נוספת מחזירה את מה
   * שנשמר. **קיום השורה הוא עצמו נתון:** שורה עם `virtualNumberId`
   * ריק אומרת „נצפה, ולא התאים אף מספר”, ולא „טרם נצפה”. בלי
   * ההבחנה הזו מספר שהוגדר אחרי תחילת השיחה היה נתפס בסופה — אותו
   * באג בכיוון ההפוך.
   *
