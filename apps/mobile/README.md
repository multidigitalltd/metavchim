...
| נכסים · נכס חדש · נכס · עריכה | קליטה ועריכה באותו טופס (כתובת, הנכס, מאפיינים, בעל הנכס, כניסה ושיווק); פרטים, מוכנות ומה חסר, בעל הנכס, לקוחות מתאימים, משימה, קביעת סיור |
| לקוחות · לקוח חדש · לקוח · עריכה | קליטה ועריכה באותו טופס (מי, מה מחפשים, מאפיינים, מימון ובשלות); נכסים מתאימים, משימה, קביעת פגישה |
...
app/                 ניתוב לפי קבצים (expo-router)
  ...
  leads/  properties/  buyers/   index (רשימה) · [id] · new · edit/[id]
