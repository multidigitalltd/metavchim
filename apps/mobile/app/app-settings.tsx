...
const PUSH_TEXT: Record<PushStatus, string> = {
  ...
  undetermined: "עדיין לא הופעלו במכשיר הזה. בינתיים ההתראות מגיעות בסריקת רקע כל כרבע שעה.",
  denied: "ההרשאה נחסמה. אפשר לפתוח אותה מחדש בהגדרות המכשיר.",
  unsupported:
    "פוש ישיר אינו מוגדר בבנייה הזו. ההתראות מגיעות בסריקת רקע כל כרבע שעה, כולל המונה על האייקון.",
};
