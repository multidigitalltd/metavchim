  ...
  return (
    ...
    >
      ...
      {!preview.archived ? (
        ...
        /*
         * ‎**המשפט מתאר את מה שקורה, ולא מבטיח יותר.**
         *
         * הוא אמר „הלקוח עצמו והלידים שלו יישארו” בלי תנאי, בזמן
         * שהמחיקה מסירה גם כרטיס לקוח שלא נשאר לו שום קשר אחר במשרד
         * ושום היסטוריה. הבטחה בדיאלוג אישור אינה נוסח — היא חלק
         * מהפעולה, ומחיקה שמוחקת יותר ממה שהוסכם היא בדיוק הדבר
         * שאסור (ביקורת Codex, P1).
         *
         * ‎**ומה שיש עליו היסטוריה אינו נמחק בשום מקרה** — שיחה,
         * הודעה, הסכם או מסמך שומרים את הכרטיס במקומו.
         */
        <p className="m-0 mb-2 text-[length:var(--type-caption-lg)]" style={{ color: "var(--color-danger)" }}>
          מחיקה לצמיתות אינה הפיכה. הלידים של הלקוח יישארו, וכרטיס הלקוח עצמו
          יישאר כל עוד נשאר לו קשר כלשהו במשרד — כרטיס אחר, נכס, או היסטוריית
          תקשורת. לקוח שנוצר עבור הכרטיס הזה בלבד ואין עליו דבר נמחק איתו.
        </p>
      )}
