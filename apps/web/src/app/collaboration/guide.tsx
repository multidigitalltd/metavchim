  ...
  return (
    ...
    >
      ...
      >
        ...
        <li>
          <b>המשרד המפנה מצהיר על איכות הלקוח</b> ברגע הפרסום — רצינות, ריאליות
          התקציב, דחיפות וזמינות — וההצהרה מוצגת בלוח <b>לפני התשלום</b>. זה מה
          שמאפשר להחליט על ההפניה שלפניכם, ולא על ממוצע של משרד.
        </li>
        <li>
          <b>המשרד הקולט מאשר</b> אחרי שעבד עם הלקוח, באותם ממדים. המוניטין הוא
          <b> הפער בין ההצהרה לאישור</b>: משרד שמצהיר „בינוני” ומקבל אישור
          „בינוני” מקבל ציון מלא, ומשרד שמנפח מקבל ציון נמוך גם על לקוח טוב.
        </li>
      </ul>
      <p
        className="m-0 text-[12.5px]"
