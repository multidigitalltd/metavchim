  ...
  return (
    <section className="mv-card mv-card--pad mb-[18px]" aria-labelledby="coop-heading">
      <div className="mv-card-head">
        ...
        <span className="mv-chip mv-chip--good">
          <IconGlobe s={13} /> הרשת פעילה
        </span>
        <span className="mv-card-head__spacer" />
        {/*
        ...
        */}
        <Link href="/buyers" className="mv-button mv-button--secondary" style={{ textDecoration: "none" }}>
