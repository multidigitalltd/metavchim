 ...
 *
 * ה-`servers` חייב להצביע על הדומיין שממנו העמוד נטען בפועל. קובץ
 * ב-`public` היה מקבע כתובת אחת, ואז כל התקנה שאינה שלנו הייתה
 * מקבלת מפרט שמצביע למקום הלא נכון — כלומר דוגמאות ששולחות את
 * הלידים של משרד אחד למערכת של אחר.
 */
