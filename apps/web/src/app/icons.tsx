...
/**
 * הסימן של Google — **החריג היחיד** לכלל קווי המתאר ב-currentColor.
 *
 * לוגו של צד שלישי אינו אייקון ממשק: הוא סימן מסחרי, ותנאי השימוש של
 * Google לכפתורי התחברות מחייבים את הצורה והצבעים המקוריים. אייקון
 * מפתח כללי במקומו אינו רק פחות מזוהה — הוא גם לא עומד בתנאים.
 *
