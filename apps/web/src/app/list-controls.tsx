...
export function useFilterFromUrl(
  ...
  useEffect(() => {
     ...
     *
     * ‎`params` הוא אובייקט חדש בכל רינדור, ולכן הכללתו הייתה מריצה
     * את הקריאה מה-URL בכל רינדור — כלומר דריסה של כל שינוי מסנן
     * שהמשתמש עשה, בחזרה למה שכתוב בכתובת. זה בדיוק ההפך ממה
     * שהפונקציה נועדה לעשות.
     */
