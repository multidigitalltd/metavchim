    ...
    <div className="mx-auto max-w-3xl pb-16">
      ...
      <section className="mv-list-card p-6" aria-labelledby="contact-heading">
        {sent ? (
          ...
          <>
            <h2 id="contact-heading" className="m-0 mb-1" style={{ fontSize: 19, fontWeight: 800 }}>
              מעוניינים בנכס?
            </h2>
            ...
            <form onSubmit={(e) => void onSubmit(e)} className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <button type="submit" disabled={sending} className="mv-btn-action w-full" style={{ padding: "12px 0", fontSize: 15 }}>
