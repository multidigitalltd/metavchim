  ...
  return (
    <section aria-labelledby="platform-backups-heading" className="mb-8">
      ...
      <p className="mb-3 text-sm" style={{ color: "var(--color-text-muted)" }}>
        גיבוי מסד נתונים <b>וגם מדיה</b> כל 24 שעות, וסנכרון אוטומטי לאחסון מחוץ
        לשרת כל 6 שעות. שמירה: 30 יום לשניהם. המדיה כוללת תמונות נכסים, הקלטות
        שיחה, צירופי פניות וחתימות על מסמכים.
      </p>
