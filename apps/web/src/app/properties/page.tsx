      ...
      */}
      ...
      >
        <ListFilters
          ...
          card={{ flush: true }}
          /*
            ‎**במובייל: אייקון סינון במקום שורת כפתורים** (בקשת
            ‏המשתמש). בטלפון הפקדים תפסו שלוש שורות לפני הנכס
            ‏הראשון; עכשיו נשארת שורה אחת עם השדה והאייקון, והשאר
            ‏נפתח בלחיצה. בדסקטופ לא משתנה דבר.
          */
          mobileToggle
