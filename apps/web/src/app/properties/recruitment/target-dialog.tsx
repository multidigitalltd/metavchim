...
export function TargetDialog({
  ...
  return (
    <dialog
       ...
       * ‏Codex תיקנה כאן תיאור שגוי שהועתק מ-`ConfirmDialog`).
       *
       * ‎**וזו ההתנהגות הרצויה כאן**, ולא פער שנסגר ב-`closedby`:
       * ‏החלונית הזאת מחזיקה טופס. לחיצה מקרית ליד החלון בזמן
       * ‏הקלדה הייתה מוחקת את מה שהוקלד בלי לשאול. יציאה נעשית
       * ‏ב-X, ב-Escape או ב„ביטול” — שלוש דרכים מכוונות.
       *
       * ‏בלי המאזין הדפדפן היה סוגר ב-Escape בעוד ה-state של
       * ‏הקורא נשאר „פתוח”, והחלונית לא הייתה נפתחת שוב.
       */
      onCancel={(event) => {
