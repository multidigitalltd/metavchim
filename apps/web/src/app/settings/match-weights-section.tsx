    ...
    <>
      ...
      */}
        ...
        >
          ...
          מוציאים התאמה מהרשימה — מיקום מחוץ למה שהקונה ביקש, מחיר מחוץ לרצועת
          התקציב (עד 400 אלף ₪ מעל או מתחת למסומן, ובשכירות 15%), מספר חדרים
          מחוץ לטווח ביותר מחצי חדר, או דרישת חובה שהנכס מפר. כדי להתעלם
          מהמיקום, הסירו מהקונה גם את הערים וגם את אזורי החיפוש על המפה.
        </p>
