          ...
          {tickets.map((t) => (
            ...
            >
              ...
              {t.reply !== undefined ? (
                ...
                >
                  <p className="m-0 text-[length:var(--type-caption)] font-bold">תשובת התמיכה</p>
                  <p className="m-0 mt-0.5 whitespace-pre-wrap text-[length:var(--type-body-sm)]">{t.reply}</p>
                </div>
              ) : null}
            </li>
          ))}
