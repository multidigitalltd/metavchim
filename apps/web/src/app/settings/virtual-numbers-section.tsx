                  ...
                  {data.numbers.map((number) => (
                    <tr key={number.id} style={{ opacity: number.isActive ? 1 : 0.55 }}>
                      <td>
                        {number.label}
                        {!number.isActive && (
                          <span className="mv-pill ms-2" style={{ fontSize: 11 }}>
                            מושבת
                          </span>
                        )}
                      </td>
                      ...
                      <td>
                        <div className="flex flex-wrap gap-2">
                          ...
                          {/*
                            אישור לפני מחיקה: המדידה ההיסטורית שורדת
                            (השיחות שומרות את המספר), אבל השם אובד —
                            ואז הדוח מציג מספר בלי להסביר מה הוא היה.
                          */}
