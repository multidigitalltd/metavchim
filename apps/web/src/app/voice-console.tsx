  ...
  return (
    ...
    <section className="mv-agent mb-4" aria-labelledby="agent-console-title">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        */}
        {/*
          ‎`browserOnly` — „מהיר” בלבד, לבקשת המשתמשת. כאן מדברים
          פקודה קצרה ורוצים לראות אותה זוחלת על המסך תוך כדי; שני
          כפתורים לפעולה אחת קצרה הם בחירה מיותרת. שאר שדות הטקסט
          במערכת שומרים את שני המצבים, כי שם מכתיבים תיאור נכס או
          סיכום שיחה וכן משתלם להמתין לתמלול המדויק.
        */}
        <DictationControls
          browserOnly
          onAppend={(spoken) => {
