        ...
        if (proposal.actionId === "unknown") {
          ...
          push({
            ...
            text: [
              ...
              /*
               * ‎**מה שכן עובד עכשיו — ולא רק מה שנכשל.**
               *
               * הנוסח והרשימה משותפים לוואטסאפ ולמסך: הסבר שיושב
               * בצד אחד בלבד הוא הסבר שהצד השני ימציא מחדש, וכאן
               * הוא פשוט לא היה שם. הרשימה נגזרת מהמפה שמכריעה מה
               * מנוע החוקים מזהה, ולכן אינה יכולה להבטיח פעולה
               * שתיכשל.
               */
              ...proposal.degraded,
              ...proposal.warnings,
