        ...
        <div className="mv-proposal">
          ...
          */}
          {proposal.fallback ? (
            ...
            >
              שירות ההבנה החכמה אינו מוגדר בהתקנה הזו, ולכן מזוהים רק
              ניסוחים מוכרים. אפשר להגדיר אותו במסך ההגדרות — ואז הסוכן
              יבין גם משפטים חופשיים.
            </p>
          ) : null}
