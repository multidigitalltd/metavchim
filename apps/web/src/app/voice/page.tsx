      ...
      try {
        ...
        if (proposal.actionId === "unknown") {
          ...
          push({
            ...
            text: [
              /*
               * ‎**„אפשר לנסח אחרת” **מוחלף** ולא מוקדם להסבר.**
               *
               * כשההבנה החכמה נפלה, שום ניסוח לא יצליח עד שהספק
               * יחזור — ושורת „נסחו אחרת” מיד לפני ההסבר על התקלה
               * היא בדיוק ההוראה חסרת הסיכוי שה-PR הזה בא להסיר.
               * הוואטסאפ כבר מחליף; המסך היה מוסיף (ביקורת Codex).
               *
               * הנוסח והרשימה משותפים לשני הערוצים, והרשימה נגזרת
               * מהמפה שמכריעה מה מנוע החוקים מזהה — ולכן אינה
               * יכולה להבטיח פעולה שתיכשל.
               */
              ...(proposal.degraded.length > 0
                ? proposal.degraded
                : [
                    /*
                     * שאלת ההבהרה של המודל קודמת לכותרת ההצעות
                     * ואינה נבלעת בה: היא ספציפית למשפט, וההצעות
                     * הן הכללי שמתחתיה.
                     */
                    proposal.clarify ??
