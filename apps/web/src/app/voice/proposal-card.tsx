...
export interface Proposal {
  ...
  fallback: boolean;
  /**
   * ‎**מה עדיין עובד** כשההבנה החכמה אינה זמינה — שורות מוכנות.
   *
   * מגיע מהשרת: הרשימה תלויה במה שמותר למתווך הזה, והמסך אינו יודע
   * את זה. אותן שורות בדיוק נשלחות גם בוואטסאפ.
   *
   * נשלח תמיד, ריק כשאין מה לומר — שדה חסר הוא תשובה פגומה.
   */
  degraded: string[];
