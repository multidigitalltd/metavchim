 ...
 * ## שני מקומות, מקור אחד
 *
 * ההתאמות זמינות משני מקומות: **כפתור הנגישות** שצף בצד כל מסך
 * (`a11y-toolbar.tsx`), ועמוד הפרופיל. הכפתור הוא הדרך שהתקן
 * מצפה לה — ת"י 5568 דורש שההתאמות יהיו נגישות מכל עמוד, כולל
 * עמודים ציבוריים כמו דף ההצעה ומסך ההתחברות, שאין בהם פרופיל
 * בכלל. עמוד הפרופיל נשאר למי שמעדיף מסך מלא ומסודר.
 *
