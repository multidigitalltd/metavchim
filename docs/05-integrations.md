...
בלבד — מזהה דף התשלום — וגם הוא רק כדי לשאול את קארדקום מה באמת קרה
(`GetLpResult`). ההכרעה תמיד מהתשובה שאנחנו משכנו, ולעולם לא מגוף
...
**מה עדיין לא קיים:** חידוש אוטומטי בטוקן השמור. הטוקן נשמר מוצפן
ומוכן, אבל אין עדיין סורק שמחייב בתום התקופה — החידוש כרגע ידני,
דרך אותו מסך. חשבוניות (חשבונית ירוקה/iCount) גם הן טרם חוברו.
