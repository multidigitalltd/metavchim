 ...
 * ‏אומר „לצמיתות” במפורש.
 *
 * ‏הכפתור נקרא פעם „סימון לא רלוונטי”, שנשמע הפיך, והאישור היה
 * ‏המקום **היחיד** שבו אפשר היה לתקן את הרושם. עכשיו הוא נקרא
 * ‏„מחיקת שיחות לא רלוונטיות” (בקשת המשתמש), והשניים אומרים את
 * ‏אותו דבר: הכפתור מה יקרה, והאישור שזה בלתי הפיך.
 *
