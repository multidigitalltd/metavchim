/**
 * לאן מובילה התראה — מקור אמת אחד לפעמון, למסך ההתראות **ולאפליקציה לנייד**.
 *
 * שתי רשימות נפרדות היו מתפצלות ביום שמתווסף סוג ישות: ההתראה
 * הייתה לחיצה במסך אחד ומתה בשני. עבר לחבילה המשותפת כשהאפליקציה
 * לנייד התחילה לפתוח את אותם יעדים — בעצמה או בדפדפן המוטמע שלה.
 */
